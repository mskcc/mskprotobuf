...
func (r ApiFetchPdbHeaderGETRequest) Execute() (*PdbHeader, *http.Response, error) {
	return r.ApiService.FetchPdbHeaderGETExecute(r)
}

/*
FetchPdbHeaderGET Retrieves PDB header info by a PDB id
...
// List of pdb ids, for example [\&quot;1a37\&quot;,\&quot;1a4o\&quot;]
func (r ApiFetchPdbHeaderPOSTRequest) PdbIds(pdbIds []string) ApiFetchPdbHeaderPOSTRequest {
	r.pdbIds = &pdbIds
	return r
}

func (r ApiFetchPdbHeaderPOSTRequest) Execute() ([]PdbHeader, *http.Response, error) {
	return r.ApiService.FetchPdbHeaderPOSTExecute(r)
}

/*
FetchPdbHeaderPOST Retrieves PDB header info by a PDB id
...
func (a *PdbControllerApiService) FetchPdbHeaderPOSTExecute(r ApiFetchPdbHeaderPOSTRequest) ([]PdbHeader, *http.Response, error) {
	...
	localVarPath := localBasePath + "/pdb/header"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pdbIds == nil {
		return localVarReturnValue, nil, reportError("pdbIds is required and must be specified")
	}
